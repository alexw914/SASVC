...
if [[ $# != 8 ]];then
	...
	echo "egs. $0 egs/vox1/train/plda.python.ori ark:egs/vox1/train-in-domain/train.egs.ark egs/vox1/train-indomain/plda.python.ori ark:egs/vox1/enroll/train.egs.ark ark:egs/vox1/test/train.egs.ark
			   egs/vox1/train/plda.python.adapt data/voxceleb1_test/trials egs/vox1/train/plda.cipreg.score"
...
# plda
python3 subtools/score/pyplda/ivector-adapt-plda-cip-reg.py $plda_out_domain $train_vec_adapt $plda_in_domain $plda_adapt
