...
def get_enrol_protocols(pro_dir = 'cm/ASVspoof2019/LA/ASVspoof2019_LA_asv_protocols',
                    enrol_files = ('ASVspoof2019.LA.asv.eval.female.trn.txt',
                                  'ASVspoof2019.LA.asv.eval.male.trn.txt'),
                    data_dir = 'cm/ASVspoof2019/LA/ASVspoof2019_LA_eval/flac',
                    save_dir = 'spk_meta' 
                    ):
    enroll_list = {}
    enroll = {}
    ...
    with open(os.path.join(save_dir, enroll_save_file), 'w') as f:
        json.dump(enroll, f, indent=2)
    with open(os.path.join(save_dir, enroll_list_save_file), 'w') as f:
        json.dump(enroll_list,f,indent=2)

def get_eval_protocols(pro_dir = 'protocols/asv_protocols',
    ...
    with open(os.path.join(save_dir, save_file), 'w') as f:
        json.dump(eval_features, f, indent=2)
